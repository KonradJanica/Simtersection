...
public class Utils {
	...
	public static final boolean vehicleDebugging = true;
	/**Enables the advanced debugging tools in the Vehicle class.*/
	public static final boolean vehicleDebuggingAdvanced = true;
	...
	public static final boolean TickChangeStateDebugging = true;
	/**Enables the drawing FPS in the top left hand conrner of the SimPanel.*/
	public static final boolean FPSDrawing = true;

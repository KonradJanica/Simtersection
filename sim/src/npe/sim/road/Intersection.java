...
//			}
		...
		PedestrianLane pLaneWest = northTce.getPedestrianLanes().get(0);
		PedestrianLane pLaneEast = northTce.getPedestrianLanes().get(1);
		if (taxiRankEnabled) {	
			taxiRank = new TaxiRank(rankX, rankY, rankLane, pLaneEast, pLaneWest);
		}
